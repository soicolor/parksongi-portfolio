!(function (t, e) {
    ...
    function measureSegment(t, e, n) {
        ...
        for (T.length = S.length = 0, a = e + 2; a < b; a += 6) {
            if (
                ...
                for (r = 1; r <= x; r++)
                    (l = h - (h = ((m = y * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m)),
        ...
        if (T.length && _)
            for (
                t.totalLength = w = T[T.length - 1] || 0, t.minLength = _, v = P = 0, r = 0;
                r < w;
                r += _
            )
                S[v++] = T[P] < r ? ++P : P;
    ...
    function getProgressData(t, e, n) {
        ...
        var r,
            ...
            u = t[0];
        if (1 < t.length) {
            for (o = t.totalLength * e, s = l = 0; (s += t[l++].totalLength) < o; ) h = l;
    ...
    function pointsToSegment(t, e, n) {
        var r,
            ...
            M = x - v,
            R = y - w;
        for (isNaN(n) && (n = Math.PI / 10), e = e || 0 === e ? +e : 1, s = 2; s < P; s += 2)
            (r = v),
                (a = w),
                (v = x),
                (w = y),
    ...
    function rawPathToString(t) {
        ...
        for (n = 0; n < i; n++) {
            for (
                a = t[n], o += 'M' + O(a[0]) + ',' + O(a[1]) + ' C', e = a.length, r = 2;
                r < e;
                r++
            )
                o +=
                    ...
                    : (l.length || l.push(U(t, 1), U(t, 2), U(t, 3)),
                      ...
                      i
                          ...
                          : ((e.style.top = t.offsetTop + 'px'),
                            ...
                            (e.style[w] = n[w]),
                            (e.style[M] = n[M]),
                            (e.style.position = 'fixed' === n.position ? 'fixed' : 'absolute'),
                ...
                a.left +
                    (l
                        ...
                        : (function _getDocScrollLeft() {
                              return (
                                  g.pageXOffset || u.scrollLeft || f.scrollLeft || c.scrollLeft || 0
                              );
                          })()),
                a.top +
                    (l
                        ...
                        : (function _getDocScrollTop() {
                              return (
                                  g.pageYOffset || u.scrollTop || f.scrollTop || c.scrollTop || 0
                              );
                          })())
            );
    ...
    var I,
        ...
        Y = function _addDimensionalPropTween(t, e, n, r, a, o) {
            ...
            (s.u = k(i.get(e, n, o)) || 0), (s.path = r), (s.pp = a), t._props.push(n);
        },
        a = {
            version: '3.0.2',
            name: 'motionPath',
            ...
            init: function init(t, e) {
                ...
                if (
                    ...
                    cacheRawPathMeasurements((n = u(X(getRawPath(e.path), t, e))), e.resolution),
                        i.push(n),
                    ...
                    for (r in (a && o
                        ? i.push(
                              ha(this, ea(ea([], s, a, 0), s, o, 1), t, e.x || a, e.y || o, u, e)
                          )
                        : (a = o = 0),
                    l))
                        r !== a && r !== o && i.push(ha(this, ea([], s, r, 0), t, r, 0, u, e));
                }
            },
            ...
            arrayToRawPath: function arrayToRawPath(t, e) {
                ...
                return (
                    e.relative && ga(n), ['cubic' === e.type ? n : pointsToSegment(n, e.curviness)]
                );
            },
        };
    !(function _getGSAP() {
